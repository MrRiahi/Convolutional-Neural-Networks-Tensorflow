...
class VGG13:
    """
    Implementation of VGG13 network.
    """

    def __init__(self, input_shape, classes):
        """
        Initialize the VGG13 network.
        :param input_shape: input shape of image
        :param classes: number of classes
        :return:
        """
    ...
    def vgg13(self):
        ...
        # Third conv block
        X = self.__conv_block(X=X, number_of_filters=[256, 256])
...
class VGG11:
    """
    Implementation of VGG11 network.
    """
    ...
    def vgg11(self):
        ...
        # First conv block
        X = self.__conv_block(X=X_input, number_of_filters=[64])

        # Max pooling
        X = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='valid')(X)

        # Second conv block
        X = self.__conv_block(X=X, number_of_filters=[128])
