...
class VGG16TestCase(unittest.TestCase):
    """
    Test cases for VGG16 convolutional neural network.
    """

    def test_vgg16(self):
        """
        Test the VGG16 model layers.
        """

        n_classes = 15
        vgg16_obj = VGG16(input_shape=(224, 224), classes=n_classes)
        model = vgg16_obj()
    ...
    def get_model_summary(model):
        """
        Get the configuration of the VGG16 model.
        :param model:
        :return:
        """
    ...
    def get_expected_model_config(n_classes):
        """
        Get the expected VGG16 model configuration.
        :param n_classes:
        :return:
        """
        ...
        expected_model_config = [
            ...
            ['Conv2D', (None, 224, 224, 64), 36928, (3, 3), (1, 1), 'same', 'linear'],
            ['BatchNormalization', (None, 224, 224, 64), 256],
            ['Activation', (None, 224, 224, 64), 0, 'relu'],
            # Max pooling block 1
            ...
            ['Conv2D', (None, 112, 112, 128), 147584, (3, 3), (1, 1), 'same', 'linear'],
            ['BatchNormalization', (None, 112, 112, 128), 512],
            ['Activation', (None, 112, 112, 128), 0, 'relu'],
            # Max pooling block 2
