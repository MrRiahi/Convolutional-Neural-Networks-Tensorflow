...
class InceptionResNetV2:
    """
    This class is the implementation of the Inception-ResNetV2 convolutional neural network.
    This network consist of six parts:
        1) stem
        2) inception_resnet_v2_A
        3) inception_resnet_v2_B
        4) inception_resnet_v2_C
        5) reduction_A
        6) reduction_B
    """
    ...
    def __inception_resnet_a(X, scale=0.1):
        """
        Build the Inception-ResNet-A block of the Inception-ResNetV2.
        :param X:
        :param scale:
        :return:
        """
        ...
        X_b3 = Conv2D(filters=48, kernel_size=(3, 3), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b3)
        X_b3 = BatchNormalization()(X_b3)
        X_b3 = Activation('relu')(X_b3)

        X_b3 = Conv2D(filters=64, kernel_size=(3, 3), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b3)
        X_b3 = BatchNormalization()(X_b3)
        X_b3 = Activation('relu')(X_b3)
        ...
        # linear conv layer
        X_shortcut = Conv2D(filters=384, kernel_size=(1, 1), strides=(1, 1), padding='same',
    ...
    def __reduction_a(X):
        """
        Build the Reduction-A block of the Inception-ResNetV2 network.
        :param X:
        :return:
        """
        ...
        X_b3 = Conv2D(filters=384, kernel_size=(3, 3), strides=(2, 2), padding='valid',
                      kernel_initializer=random_uniform)(X_b3)
        X_b3 = BatchNormalization()(X_b3)
        X_b3 = Activation('relu')(X_b3)
    ...
    def __inception_resnet_b(X, scale=0.1):
        """
        Build the Inception-ResNet-B block of the Inception-ResNetV2.
        :param X:
        :param scale:
        :return:
        """
        ...
        X_b2 = Conv2D(filters=160, kernel_size=(1, 7), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b2)
        X_b2 = BatchNormalization()(X_b2)
        X_b2 = Activation('relu')(X_b2)

        X_b2 = Conv2D(filters=192, kernel_size=(7, 1), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b2)
        X_b2 = BatchNormalization()(X_b2)
        X_b2 = Activation('relu')(X_b2)
    ...
    def __reduction_b(X):
        """
        Build the Reduction-B block of the Inception-ResNetV2 network.
        :param X:
        :return:
        """
        ...
        X_b3 = Conv2D(filters=288, kernel_size=(3, 3), strides=(2, 2), padding='valid',
                      kernel_initializer=random_uniform)(X_b3)
        X_b3 = BatchNormalization()(X_b3)
        X_b3 = Activation('relu')(X_b3)
        ...
        X_b4 = Conv2D(filters=288, kernel_size=(3, 3), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b4)
        X_b4 = BatchNormalization()(X_b4)
        X_b4 = Activation('relu')(X_b4)

        X_b4 = Conv2D(filters=320, kernel_size=(3, 3), strides=(2, 2), padding='valid',
                      kernel_initializer=random_uniform)(X_b4)
        X_b4 = BatchNormalization()(X_b4)
        X_b4 = Activation('relu')(X_b4)
    ...
    def __inception_resnet_c(X, scale=0.1):
        """
        Build the Inception-ResNet-C block of the Inception-ResNetV2.
        :param X:
        :param scale:
        :return:
        """
        ...
        X_b2 = Conv2D(filters=224, kernel_size=(1, 3), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b2)
        X_b2 = BatchNormalization()(X_b2)
        X_b2 = Activation('relu')(X_b2)

        X_b2 = Conv2D(filters=256, kernel_size=(3, 1), strides=(1, 1), padding='same',
                      kernel_initializer=random_uniform)(X_b2)
        X_b2 = BatchNormalization()(X_b2)
        X_b2 = Activation('relu')(X_b2)
        ...
        # linear conv layer
        X_shortcut = Conv2D(filters=2048, kernel_size=(1, 1), strides=(1, 1), padding='same',
                            kernel_initializer=random_uniform)(X_concat)
        X_shortcut = BatchNormalization()(X_shortcut)
    ...
    def __call__(self):
        """
        Build the Inception-ResNetV2 network.
        """
